            ...
            if(modeDiscover) {
                ...
                if(energyMonitorDevices.count == 0) {
                    ...
                    Button("Rescan...") {
                        ...
                        Divider()
                        List(emdevices, id:\.self) { device in
                            let altername = device.alternateName ?? "--"
                            HStack {
                                Text("\(altername)").font(.system(size: 16))
                                Button {
                                    print("Tapped")
                                    print("Host is: \(altername)")
                                    hostname = device.mdnsName ?? "--"
